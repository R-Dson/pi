/**
 * Verify the documentation example snippets from extensions.md compile.
 * The custom-compaction example file itself is exercised (request shape,
 * fallbacks) by custom-compaction-example.test.ts.
 */
